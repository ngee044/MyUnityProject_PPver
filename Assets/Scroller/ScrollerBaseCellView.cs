...
namespace nsEnhancedScroller
{
    ...
    /// </summary>
    public class ScrollerBaseCellView : EnhancedScrollerCellView
    {
        /// <summary>
        /// Reference to the underlying data driving this view
        /// </summary>
        //private ScrollerBaseData _data;
        ...
        virtual public void SetData(int dataIndex, ScrollerBaseData data, bool isVertical)
        {
        ...
        override protected void BtnSelect()
        {
            Debug.Log("BtnSelect = " + selected);
