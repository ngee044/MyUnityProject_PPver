...
public class CameraFilterPack_Blur_Focus
{
    #region Variables
    ...
    //Transform m_MyPlayer2DPos; //character position value
    ...
    void Update()
    {
        ...
        {
            if(SharedObject.g_CollectorMgr.Player.IsDie())
            {
                DieUpdate();
                return;
            }
